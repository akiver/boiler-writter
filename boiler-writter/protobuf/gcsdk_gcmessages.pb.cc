...
void protobuf_AssignDesc_gcsdk_5fgcmessages_2eproto() {
  ...
  static const int CMsgServerHello_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(CMsgServerHello, legacy_client_launcher_),
  ...
  GCConnectionStatus_descriptor_ = file->enum_type(0);
}
...
void protobuf_AddDesc_gcsdk_5fgcmessages_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\030\004 \001(\r\"\272\001\n\017CMsgServerHello\022\017\n\007version\030\001 "
    "\001(\r\0226\n\025socache_have_versions\030\002 \003(\0132\027.CMs"
    "gSOCacheHaveVersion\022\"\n\032legacy_client_ses"
    "sion_need\030\003 \001(\r\022\036\n\026legacy_client_launche"
    "r\030\004 \001(\r\022\032\n\022steamdatagram_port\030\005 \001(\r\"\364\002\n\021"
    "CMsgClientWelcome\022\017\n\007version\030\001 \001(\r\022\021\n\tga"
    "me_data\030\002 \001(\014\022;\n\033outofdate_subscribed_ca"
    "ches\030\003 \003(\0132\026.CMsgSOCacheSubscribed\022A\n\032up"
    "todate_subscribed_caches\030\004 \003(\0132\035.CMsgSOC"
    "acheSubscriptionCheck\022-\n\010location\030\005 \001(\0132"
    "\033.CMsgClientWelcome.Location\022\022\n\ngame_dat"
    "a2\030\006 \001(\014\022$\n\034rtime32_gc_welcome_timestamp"
    "\030\007 \001(\r\022\020\n\010currency\030\010 \001(\r\032@\n\010Location\022\020\n\010"
    "latitude\030\001 \001(\002\022\021\n\tlongitude\030\002 \001(\002\022\017\n\007cou"
    "ntry\030\003 \001(\t\"\345\001\n\024CMsgConnectionStatus\022D\n\006s"
    "tatus\030\001 \001(\0162\023.GCConnectionStatus:\037GCConn"
    "ectionStatus_HAVE_SESSION\022\033\n\023client_sess"
    "ion_need\030\002 \001(\r\022\026\n\016queue_position\030\003 \001(\005\022\022"
    "\n\nqueue_size\030\004 \001(\005\022\024\n\014wait_seconds\030\005 \001(\005"
    "\022(\n estimated_wait_seconds_remaining\030\006 \001"
    "(\005\"\206\003\n*CWorkshop_PopulateItemDescription"
    "s_Request\022\r\n\005appid\030\001 \001(\r\022\\\n\tlanguages\030\002 "
    "\003(\0132I.CWorkshop_PopulateItemDescriptions"
    "_Request.ItemDescriptionsLanguageBlock\032^"
    "\n\025SingleItemDescription\022\022\n\ngameitemid\030\001 "
    "\001(\r\022\030\n\020item_description\030\002 \001(\t\022\027\n\017one_per"
    "_account\030\003 \001(\010\032\212\001\n\035ItemDescriptionsLangu"
    "ageBlock\022\020\n\010language\030\001 \001(\t\022W\n\014descriptio"
    "ns\030\002 \003(\0132A.CWorkshop_PopulateItemDescrip"
    "tions_Request.SingleItemDescription\"F\n!C"
    "Workshop_GetContributors_Request\022\r\n\005appi"
    "d\030\001 \001(\r\022\022\n\ngameitemid\030\002 \001(\r\":\n\"CWorkshop"
    "_GetContributors_Response\022\024\n\014contributor"
    "s\030\001 \003(\006\"\325\003\n%CWorkshop_SetItemPaymentRule"
    "s_Request\022\r\n\005appid\030\001 \001(\r\022\022\n\ngameitemid\030\002"
    " \001(\r\022a\n\031associated_workshop_files\030\003 \003(\0132"
    ">.CWorkshop_SetItemPaymentRules_Request."
    "WorkshopItemPaymentRule\022W\n\020partner_accou"
    "nts\030\004 \003(\0132=.CWorkshop_SetItemPaymentRule"
    "s_Request.PartnerItemPaymentRule\032i\n\027Work"
    "shopItemPaymentRule\022\030\n\020workshop_file_id\030"
    "\001 \001(\004\022\032\n\022revenue_percentage\030\002 \001(\002\022\030\n\020rul"
    "e_description\030\003 \001(\t\032b\n\026PartnerItemPaymen"
    "tRule\022\022\n\naccount_id\030\001 \001(\r\022\032\n\022revenue_per"
    "centage\030\002 \001(\002\022\030\n\020rule_description\030\003 \001(\t\""
    "(\n&CWorkshop_SetItemPaymentRules_Respons"
    "e*\325\001\n\022GCConnectionStatus\022#\n\037GCConnection"
    "Status_HAVE_SESSION\020\000\022$\n GCConnectionSta"
    "tus_GC_GOING_DOWN\020\001\022!\n\035GCConnectionStatu"
    "s_NO_SESSION\020\002\0220\n,GCConnectionStatus_NO_"
    "SESSION_IN_LOGON_QUEUE\020\003\022\037\n\033GCConnection"
    "Status_NO_STEAM\020\004B\005H\001\200\001\000", 4264);
...
const int CMsgServerHello::kLegacyClientLauncherFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_legacy_client_launcher;
        break;
      }
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_legacy_client_launcher:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, &legacy_client_launcher_)));
          set_has_legacy_client_launcher();
        } else {
          goto handle_uninterpreted;
        }
...
void CMsgServerHello::SerializeWithCachedSizes(
  ...
  // optional uint32 legacy_client_launcher = 4;
  if (has_legacy_client_launcher()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->legacy_client_launcher(), output);
  }
...
::google::protobuf::uint8* CMsgServerHello::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 legacy_client_launcher = 4;
  if (has_legacy_client_launcher()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->legacy_client_launcher(), target);
  }
...
void CMsgServerHello::MergeFrom(const CMsgServerHello& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_legacy_client_launcher()) {
      set_legacy_client_launcher(from.legacy_client_launcher());
    }
...
void CMsgServerHello::Swap(CMsgServerHello* other) {
  if (other != this) {
    ...
    std::swap(legacy_client_launcher_, other->legacy_client_launcher_);
