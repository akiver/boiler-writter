...
class CMsgServerHello : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_legacy_client_launcher() const;
  inline void clear_legacy_client_launcher();
  static const int kLegacyClientLauncherFieldNumber = 4;
  inline ::google::protobuf::uint32 legacy_client_launcher() const;
  inline void set_legacy_client_launcher(::google::protobuf::uint32 value);
 ...
 private:
  ...
  inline void set_has_legacy_client_launcher();
  inline void clear_has_legacy_client_launcher();
  ...
  ::google::protobuf::uint32 legacy_client_launcher_;
...
// optional uint32 legacy_client_launcher = 4;
inline bool CMsgServerHello::has_legacy_client_launcher() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void CMsgServerHello::set_has_legacy_client_launcher() {
  _has_bits_[0] |= 0x00000008u;
}
inline void CMsgServerHello::clear_has_legacy_client_launcher() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void CMsgServerHello::clear_legacy_client_launcher() {
  legacy_client_launcher_ = 0u;
  clear_has_legacy_client_launcher();
}
inline ::google::protobuf::uint32 CMsgServerHello::legacy_client_launcher() const {
  return legacy_client_launcher_;
}
inline void CMsgServerHello::set_legacy_client_launcher(::google::protobuf::uint32 value) {
  set_has_legacy_client_launcher();
  legacy_client_launcher_ = value;
}
